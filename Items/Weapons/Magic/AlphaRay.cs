...
namespace CalamityMod.Items.Weapons.Magic
{
    public class AlphaRay : ModItem, ILocalizedModType
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                Projectile.NewProjectile(source, position.X, position.Y, velocity.X * 1.35f, velocity.Y * 1.35f, ModContent.ProjectileType<GenesisBeam>(), (int)(damage * 1.6625), knockback, player.whoAmI);
                int laserAmt = 3;
