...
namespace CalamityMod.Tiles.Abyss
{
    public class HardenedSulphurousSandstone : ModTile
    {
        ...
        {
            TileFraming.DrawUniversalMergeFrames(i, j, new TileFraming.MergeFrameData(thirdTileAdjacency, "CalamityMod/Tiles/Merges/SulphurousShaleMerge"), new TileFraming.MergeFrameData(secondTileAdjacency, "CalamityMod/Tiles/Merges/StoneMerge"), new TileFraming.MergeFrameData(tileAdjacency, "CalamityMod/Tiles/Merges/DirtMerge"));
        }
