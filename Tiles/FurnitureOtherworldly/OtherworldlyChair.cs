...
namespace CalamityMod.Tiles.FurnitureOtherworldly
{
    ...
    public class OtherworldlyChair : ModTile
    {
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureOtherworldly.OtherworldlyChair>());
