...
namespace CalamityMod.Projectiles.Healing
{
    public class Exoheal : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            int dusty = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.TerraBlade, 0f, 0f, 100, new Color(0, 255, 255), 1f);
