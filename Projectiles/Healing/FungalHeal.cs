...
namespace CalamityMod.Projectiles.Healing
{
    public class FungalHeal : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            int fungi = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.BlueFairy, 0f, 0f, 100, default, 0.5f);
            ...
            int fungi2 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.BlueFairy, 0f, 0f, 100, default, 0.7f);
