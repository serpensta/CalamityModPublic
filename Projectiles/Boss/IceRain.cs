    ...
    public class IceRain : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 0f)
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    int icyDust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Frost, Projectile.velocity.X, Projectile.velocity.Y, 50, default, 0.6f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                int snowDust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Snow, 0f, 0f, 0, default, 1f);
