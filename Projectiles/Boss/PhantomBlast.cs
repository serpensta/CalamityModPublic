...
namespace CalamityMod.Projectiles.Boss
{
    public class PhantomBlast : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                int killGhostDust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.DungeonSpirit, 0f, 0f, 100, default, 1.2f);
            ...
            for (int j = 0; j < 5; j++)
            {
                int killGhostDust2 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.DungeonSpirit, 0f, 0f, 100, default, 1.7f);
                Main.dust[killGhostDust2].noGravity = true;
                Main.dust[killGhostDust2].velocity *= 5f;
                killGhostDust2 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.DungeonSpirit, 0f, 0f, 100, default, 1f);
