        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Projectile.frame < 2)
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        int ichorDust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Ichor, 0f, 0f, 200, default, 1.6f);
                        ...
                        ichorDust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Ichor, 0f, 0f, 100, default, 0.8f);
                        dust.position = Projectile.Center + Vector2.UnitY.RotatedByRandom(MathHelper.Pi) * (float)Main.rand.NextDouble() * Projectile.width / 2f;
                        dust.velocity.Y -= 2f;
                        dust.velocity *= 2f;
                        dust.noGravity = true;
                    ...
                    for (int j = 0; j < 5; j++)
                    {
                        int ichorDust2 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Ichor, 0f, 0f, 0, default, 2f);
