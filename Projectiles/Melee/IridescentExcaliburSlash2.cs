...
namespace CalamityMod.Projectiles.Melee
{
    public class IridescentExcaliburSlash2 : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            Color rainbowGoldEmphasis = new Color(255 - Main.DiscoR, 255 - Main.DiscoG, 255 - Main.DiscoB);
            ...
            Color rainbowPinkEmphasis = new Color(255 - Main.DiscoR, 255 - Main.DiscoG, 255 - Main.DiscoB);
