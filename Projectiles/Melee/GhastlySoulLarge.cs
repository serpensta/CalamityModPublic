...
namespace CalamityMod.Projectiles.Melee
{
    public class GhastlySoulLarge : ModProjectile, ILocalizedModType
    {
        ...
        private const int TimeLeft = 330;
        ...
        public override void AI()
        {
            ...
            float inertia = 20f * Projectile.ai[1];
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Vector2 rotate = Vector2.Normalize(Projectile.velocity) * new Vector2((float)Projectile.width / 2f, (float)Projectile.height) * 0.25f;
                rotate = rotate.RotatedBy((double)((float)(i - (dustAmt / 2 - 1)) * MathHelper.TwoPi / (float)dustAmt), default) + Projectile.Center;
                Vector2 faceDirection = rotate - Projectile.Center;
                int killedDust = Dust.NewDust(rotate + faceDirection, 0, 0, DustID.ShadowbeamStaff, faceDirection.X, faceDirection.Y, 100, default, 4f);
