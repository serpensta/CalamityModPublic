...
{
    public class FlakToxicannonHoldout : ModProjectile, ILocalizedModType
    {
        public override LocalizedText DisplayName => CalamityUtils.GetItemName<FlakToxicannon>();
        public override string Texture => "CalamityMod/Items/Weapons/Ranged/FlakToxicannon";
        ...
        public override void AI()
        {
            ...
            if (ShootingTimer >= heldItem.useAnimation)
            {
                ...
                if (!Main.dedServ)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("CalamityMod/Sounds/Item/FlakKrakenShoot") { Pitch = 0.65f, Volume = 0.5f }, nuzzlePosition);
                }
