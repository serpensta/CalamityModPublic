    ...
    public class AquaBlastToxic : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GemEmerald, 0f, 0f, 100, default, 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GemEmerald, 0f, 0f, 100, default, 1f);
            }
        }
