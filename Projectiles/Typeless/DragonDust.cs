    ...
    public class DragonDust : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            while ((float)timerCounter < projTimer)
            {
                ...
                rand1 *= randAdjust;
                rand2 *= randAdjust;
                int dragonDuster = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CopperCoin, 0f, 0f, 100, default, 1.5f);
